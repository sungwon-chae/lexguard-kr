...
- $\color{#3b82f6}\textsf{VERIFIED}$ &nbsp;법령과 조문 모두 현행 인덱스에 존재합니다

**초록 — 약칭으로 매칭**

- $\color{#22c55e}\textsf{ALIAS\\_MATCH}$ &nbsp;약칭으로 매칭되었습니다. 정식 명칭을 확인하세요

**노랑 — 주의 필요**

- $\color{#f59e0b}\textsf{LAW\\_ONLY}$ &nbsp;법령은 인덱스에 있으나 해당 조문번호를 찾을 수 없습니다

**빨강 — 인용 부적합**

- $\color{#ef4444}\textsf{ARTICLE\\_GAP}$ &nbsp;조문번호가 현행 법령의 범위를 크게 초과합니다
- $\color{#ef4444}\textsf{NOT\\_FOUND}$ &nbsp;법령명을 인덱스에서 찾을 수 없습니다
- $\color{#ef4444}\textsf{REPEALED}$ &nbsp;폐지된 법령입니다 (현재 데이터셋 미수록, v0.3 예정)
